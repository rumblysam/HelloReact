...
/***/ (function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Greeter, { name: first_name, message: 'Hello' }), document.getElementById('app'));
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        null,
	        React.createElement('textarea', { type: 'text', rows: '4', col: '50', ref: 'message', placeholder: 'enter message' }),
	        React.createElement('br', null)
	      ),
	      React.createElement(
	        'button',
